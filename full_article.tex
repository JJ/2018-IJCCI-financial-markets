...
\abstract{% First, motivation: Why do you need this paper
  ...
  This work proposes a decision support system that helps users
...
work. Initially, we selected the dataset proposed used by Brown, Pelosi, and
...
a number of 5 outputs gave good results in most cases. % 5 membership
                                % functions? - JJ
The FIS
...
30 times for each stock, and the results presented in Table
