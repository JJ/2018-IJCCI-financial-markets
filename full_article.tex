...
repository: \url{https://github.com/JJ/2018-IJCCI-financial-markets}. % Maybe make
                                % the data available? - JJ   % Found
                                % it! I'll add it to the
                                % repository. I'm not that sure about
                                % how I wrote this sentence. Rewrite
                                % it if you have a better way - AHA
% thanks! - JJ
...
a number of 5 outputs or MF gave good results in most cases. % 5 membership
