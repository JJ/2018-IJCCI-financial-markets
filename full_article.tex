...
Learning Repository under the name of "Dow Jones Index Data Set." In
...
records that are present in the benchmarking dataset). 
...
The final outcome of the proposed method is a recommendation to buy,
sell or hold in a financial market. The system tells the user the
direction which the market is going to take (downtrend or uptrend) and
...
future work. What follows is the explanation of this underlying
method.
